...
public class BankAcc5 {
    ...
    public int transfer(BankAcc5 dest, Float amt) {
        if (amt >= acBalance)
            return 0;
        acBalance -= amt;
        dest.acBalance += amt;
    ...
    public static void main(String[] args) {
        ...
        BankAcc5 b1 = new BankAcc5();
        BankAcc5 b2 = new BankAcc5();
        BankAcc5 b3 = new BankAcc5();
        boolean f1=false;
        boolean f2=false;
        boolean f3=false;
        int c=0;
        ...
        while(true){
            ...
            switch(choice)
            {
                ...
                case 8:
                    ...
                    f2=false;
                    f3=false;
                    System.out.println("Logged out of the system successfully.");
                    }
                    else
